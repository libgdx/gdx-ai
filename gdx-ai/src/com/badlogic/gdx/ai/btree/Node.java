...
public abstract class Node<E> {
	...
	/** This method will be called in {@link #run(E)} to inform control that this node needs to run again */
	public final void running () {
		control.childRunning(this, this);
	}

	/** This method will be called in {@link #run(E)} to inform control that this node has finished running with a success result */
	public void success () {
		end(object);
		control.childSuccess(this);
	}

	/** This method will be called in {@link #run(E)} to inform control that this node has finished running with a failure result */
	public void fail () {
		end(object);
	...
	/** This method will be called when one of the ancestors of this node needs to run again
	 * 
